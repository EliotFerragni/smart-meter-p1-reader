...
static void gpio_task_example(void* arg)
{
    ...
    for (;;) {
        if (xQueueReceive(gpio_evt_queue, &io_num, portMAX_DELAY)) {
            light_driver_set_power(!light_driver_get_power());
            printf("Toggle led. New state = %s\n", light_driver_get_power() ? "ON" : "OFF");
            ...
            esp_zb_zcl_set_attribute_val(   report_attr_cmd.zcl_basic_cmd.src_endpoint,
                                            report_attr_cmd.clusterID,
                                            report_attr_cmd.cluster_role,
                                            report_attr_cmd.attributeID, &power, false);
